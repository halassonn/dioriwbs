...
import com.github.britter.springbootherokudemo.helper.uniquejpa.service.UserAuthService;
...
public class User {
    ...
    @Unique(service = UserAuthService.class,fieldName = "username",message = "username.unique")
